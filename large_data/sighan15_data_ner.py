...
if __name__ == "__main__":
    path = "/data_local/TwoWaysToImproveCSC/BERT/data/merge_train.txt"
    path_out = "/data_local/TwoWaysToImproveCSC/BERT/data/merge_train_ner_tag.txt"
    all_texts = []
    with open(path) as f, open(path_out, "w") as fw:
        for line in f.readlines():
        ...
        for i in tqdm(range(len(all_texts))):
            ...
            index_li = [str(t) for t in index_li]
            fw.write(" ".join(index_li) + "\n")
