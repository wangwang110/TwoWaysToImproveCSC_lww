...
if __name__ == '__main__':
    data = load_train_13(
        './sighan7csc_release1.0/sighan7csc_release1.0/SampleSet/Bakeoff2013_SampleSet_WithoutError_10001-10350.txt')
    ...
    write_data(data, './train.sighan13-1.tsv')

    with open("./13train_without_error.txt", "w", encoding="utf-8") as fw:
        for item in data:
            fw.write(item['src'] + " " + item['tgt'] + "\n")
